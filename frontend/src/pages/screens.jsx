      ...
      <main className="screen screen-nav">
        <form onSubmit={(event) => { event.preventDefault(); navigate("/feed"); }}>
          ...
          <Field label="Description & Details">
            <textarea className="input" placeholder="Provide specifics (e.g. injuries, blocked lanes)..." required />
          </Field>
          <div className="section-title-row">
            <h2 className="section-label">Location</h2>
            <button type="button" className="location-button">📍 Use my current location</button>
          </div>
          <MapPreview />
          <div className="coordinate-grid">
            <input className="input" placeholder="Latitude" defaultValue="-1.3033" />
            <input className="input" placeholder="Longitude" defaultValue="36.8374" />
          </div>
