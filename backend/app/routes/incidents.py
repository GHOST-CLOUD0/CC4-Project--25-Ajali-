...
def list_incidents():
    query = IncidentService.get_incidents_query(
        incident_type=request.args.get("type", request.args.get("incident_type")),
...
def create_incident():
    ...
    try:
        incident = IncidentService.create_incident(
            ...
            incident_type=payload.get("type", payload.get("incident_type")),
            location=payload.get("location", payload.get("location_name", "")),
